...
var InnerSlider = exports.InnerSlider = function (_React$Component) {
  ...
  function InnerSlider(props) {
    ...
    _this.slideHandler = (0, _lodash4.default)(function (index) {
      ...
      var _this$props = _this.props,
          ...
          waitForAnimate = _this$props.waitForAnimate;


      if (!dontAnimate && waitForAnimate && _this.state.animating) {
        return;
      }
        ...
        setTimeout(function () {
          ...
          _this.animationEndCallback = setTimeout(function () {
            ...
            _this.setState(firstBatch, function () {
              _this.callbackTimers.push(setTimeout(function () {
                _this.setState({ animating: animating });
              }, 10));
    ...
    _this.slickPrev = function () {
      ...
      if (!_this.props.waitForAnimate || !_this.state.animating) {
        _this.callbackTimers.push(setTimeout(function () {
